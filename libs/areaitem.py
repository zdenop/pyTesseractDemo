...
class AreaItem(QGraphicsRectItem):
    remove = pyqtSignal()

    areaColor = QColor(255, 0, 0, 100)
    handleTopLeft = 1
    handleTopMiddle = 2
    handleTopRight = 3
    handleMiddleLeft = 4
    ...
    def mouseMoveEvent(self, mouseEvent):
        """
        Executed when the mouse is being moved over the item while being
        pressed.
        """
    ...
    def paint(self, painter, option, widget=None):
        ...
        """
        painter.setBrush(QBrush(self.areaColor))
    ...
    def removeArea(self):
        ...
        self.selectedChange.emit('removeArea')

    def crop2Area(self):
        """
        Crop image to Area
        """
        self.selectedChange.emit('crop2Area')
    ...
    def contextMenuEvent(self, event):
        ...
        """
        menu = QMenu()
        menu.addAction('Crop image to area', self.crop2Area)
        menu.addSeparator()
        menu.addAction('Remove area', self.removeArea)
        menu.exec_(event.screenPos())
        super(AreaItem, self).contextMenuEvent(event)
